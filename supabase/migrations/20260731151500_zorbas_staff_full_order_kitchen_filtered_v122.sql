-- Print 1 / BAR receives the complete order copy.
-- Print 2 / KITCHEN receives only items marked for kitchen.
-- The customer bill remains based on the complete order total.
...
begin
  ...
  -- Print 1 / BAR: full order copy, including kitchen and non-kitchen items.
  ...
  -- Print 2 / KITCHEN: kitchen items only.
