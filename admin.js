(() => {
  const files = ['/admin-core.js', '/admin-order.js', '/admin-waiter.js?v=20260730-waiter1', '/admin-waiter-hook.js?v=20260730-waiter1', '/admin-waiter-v2.js?v=20260730-waiter2', '/admin-keyboard-fix-v2.js?v=20260730-keyboard2', '/admin-menu.js'];
